...
export function HeroSection() {
  ...
  return (
    <motion.section 
      ref={sectionRef}
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-blue-50 to-purple-50 dark:from-gray-900 dark:via-blue-950 dark:to-purple-950 relative overflow-hidden pt-20 md:pt-0"
...
>
        ...
        >
          ...
          {/* SFS Mission & Vision */}
          <motion.p
            className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-600 dark:text-gray-400 mb-8 sm:mb-10 max-w-4xl mx-auto leading-relaxed px-2"
          ...
          <motion.div
            className="flex flex-wrap justify-center gap-2 sm:gap-4 mb-8 sm:mb-10 px-4"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <motion.div
          className="absolute bottom-[-10%] sm:bottom-[-5%] left-1/2 transform -translate-x-1/2"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 1.2, duration: 0.6 }}
        >
          <motion.div
            className="flex flex-col items-center mr-28 md:mr-0 space-y-2"
            animate={{ y: [0, 8, 0] }}
